  ...
  useEffect(() => {
    handleGetVisitAssign(idTechnical)
      .then((res) => {
        ...
        const visitasCompletadas = datosVisitas.filter(visita => visita.estado === "iniciada");
  ...
  return (
    <PageContainer>
      <ContainerService>
        ...
        {visits.length === 0 ? (
          <p style={{textAlign: "center"}}>No tienes ninguna visita en estado "Iniciada" por el momento.</p>
        ) : (
