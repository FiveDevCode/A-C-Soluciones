  ...
  useEffect(() => {
    handleGetVisitAssign(idTechnical)
      .then((res) => {
        ...
        const visitasCompletadas = datosVisitas.filter(visita => visita.estado === "cancelada");
  ...
  return (
    <PageContainer>
      <ContainerService>
        ...
        {visits.length === 0 ? (
          <p style={{textAlign: "center"}}>No tienes ninguna visita en estado "Cancelada" por el momento.</p>
        ) : (
