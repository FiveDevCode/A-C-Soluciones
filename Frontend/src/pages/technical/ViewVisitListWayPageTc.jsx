  ...
  useEffect(() => {
    handleGetVisitAssign(idTechnical)
      .then((res) => {
        ...
        const visitasCompletadas = datosVisitas.filter(visita => visita.estado === "en_camino");
  ...
  return (
    <PageContainer>
      <ContainerService>
        ...
        {visits.length === 0 ? (
          <p style={{textAlign: "center"}}>No tienes ninguna visita en estado "En camino" por el momento.</p>
        ) : (
