...
const ViewViewVisitListCompletePageTc = () => {
    ...
    if (idTechnical) {
      handleGetVisitAssign(idTechnical)
        .then((res) => {
          ...
          setFilteredVisits(visitasCompletadas);
        })
        .catch((err) => {
  ...
  return (
    <Container $collapsed={collapsed}>
      <BaseHeaderSection
        headerTitle="VISITAS COMPLETADAS"
        sectionTitle="Listado de visitas completadas"
      ...
      <Card>
        <ContainerService>
          {filteredVisits.length === 0 ? (
            <p style={{textAlign: "center", marginTop: "20px"}}>No tienes ninguna visita en estado "Completada" por el momento.</p>
          ) : (
