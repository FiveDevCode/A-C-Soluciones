...
import { handleUpdateAccounting } from '../../controllers/administrator/updateAccountingAd.controller';
...
const EditAccountingAd = () => {
  ...
  useEffect(() => {
    handleGetAccounting(id).then((res) => {
      const data = res.data;
      setAccounting(data);
  ...
  return (
    <Main>
      <ProfileInfo>
        <Avatar src="https://cdn-icons-png.flaticon.com/512/2922/2922510.png" alt="Avatar" />
        <h2>{`${accounting.nombre} ${accounting.apellido}`}</h2>
      </ProfileInfo>
