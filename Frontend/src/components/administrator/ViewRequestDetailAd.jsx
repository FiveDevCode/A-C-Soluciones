      ...
      <DialogContent>
        <Box sx={{ mt: 1 }}>
          <DetailRow>
            ...
            <Value>{selected.servicio_solicitud?.nombre || "—"}</Value>
          </DetailRow>

          <DetailRow>
            <Label>Descripción del servicio</Label>
            <Value>{selected.servicio_solicitud?.descripcion || "—"}</Value>
          </DetailRow>

          <DetailRow>
            <Label>Cliente</Label>
            <Value>
              {selected.cliente_solicitud 
          ...
          <DetailRow>
            ...
            <Value>{selected.cliente_solicitud?.telefono || "—"}</Value>
          </DetailRow>
